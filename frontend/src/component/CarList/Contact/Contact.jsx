    ...
    className="dark:bg-black dark:text-white py-14">
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 bg-gray-800 py-8 px-6">
          ...
          <p className="text-gray-400">While I cannot "collaborate" in the way you propose, I am committed to providing the support and information that empowers you to achieve success.</p>
          </div>
          <div className="grid place-items-center">
            <a href="#"
            className="inline-block font-semibold py-2 px-6 bg-primary text-white rounded-lg tracking-wider uppercase 
            hover:bg-primary/80 duration-300">Contact</a>
          </div>
        </div>
      </div>
    </div>
